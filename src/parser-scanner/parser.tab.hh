...
#line 128 "parser.tab.hh" // lalr1.cc:377
  ...
  public:
    ...
    {
      // block
      char dummy1[sizeof(BlockExpr*)];

      // class
      char dummy2[sizeof(ClassNode*)];
      ...
      // field
      char dummy4[sizeof(FieldNode*)];

      // formal
      char dummy5[sizeof(FormalNode*)];

      // method
      char dummy6[sizeof(MethodNode*)];

      // literal
      // boolean-literal
      char dummy7[sizeof(ValueExpr*)];

      // INTEGER_LITERAL
      char dummy8[sizeof(int)];

      // classes
      char dummy9[sizeof(std::list<ClassNode*>)];
      ...
      // formals
      // formals-list
      char dummy11[sizeof(std::list<FormalNode*>)];
      ...
      // class-body
      // class-body-part
      char dummy13[sizeof(std::tuple<std::list<FieldNode*>, std::list<MethodNode*>>)];
};
  ...
  basic_symbol (typename Base::kind_type t, const BlockExpr* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const ClassNode* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const ExprNode* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const FieldNode* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const FormalNode* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const MethodNode* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const ValueExpr* v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const int v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::list<ClassNode*> v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::list<ExprNode*> v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::list<FormalNode*> v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l);

  basic_symbol (typename Base::kind_type t, const std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> v, const location_type& l);
    ...
    parser (driver& drv_yyarg, ProgramNode** ast_yyarg);
    virtual ~parser ();
    ...
    , location (other.location)
  {
    ...
    {
      case 55: // block
        value.copy< BlockExpr* > (other.value);
        break;

      case 50: // class
        value.copy< ClassNode* > (other.value);
        break;
      ...
      case 51: // field
        value.copy< FieldNode* > (other.value);
        break;

      case 53: // formal
        value.copy< FormalNode* > (other.value);
        break;
      ...
      case 62: // boolean-literal
        value.copy< ValueExpr* > (other.value);
        break;
      ...
      case 45: // classes
        value.copy< std::list<ClassNode*> > (other.value);
        break;
      ...
      case 49: // formals-list
        value.copy< std::list<FormalNode*> > (other.value);
        break;
      ...
      case 47: // class-body-part
        value.copy< std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> > (other.value);
        break;
    ...
    , location (l)
  {
    ...
    {
      case 55: // block
        value.copy< BlockExpr* > (v);
        break;

      case 50: // class
        value.copy< ClassNode* > (v);
        break;
      ...
      case 51: // field
        value.copy< FieldNode* > (v);
        break;

      case 53: // formal
        value.copy< FormalNode* > (v);
        break;
      ...
      case 45: // classes
        value.copy< std::list<ClassNode*> > (v);
        break;
      ...
      case 48: // formals
      case 49: // formals-list
        value.copy< std::list<FormalNode*> > (v);
        break;
      ...
      case 46: // class-body
      case 47: // class-body-part
        value.copy< std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> > (v);
        break;
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const BlockExpr* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ClassNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ExprNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const FieldNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const FormalNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const MethodNode* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const ValueExpr* v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::list<ClassNode*> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::list<ExprNode*> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::list<FormalNode*> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  parser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  parser::basic_symbol<Base>::clear ()
  {
   ...
   default:
    ...
    {
      case 55: // block
        value.template destroy< BlockExpr* > ();
        break;

      case 50: // class
        value.template destroy< ClassNode* > ();
        break;
      ...
      case 51: // field
        value.template destroy< FieldNode* > ();
        break;

      case 53: // formal
        value.template destroy< FormalNode* > ();
        break;
      ...
      case 61: // literal
      case 62: // boolean-literal
        value.template destroy< ValueExpr* > ();
        break;
      ...
      case 45: // classes
        value.template destroy< std::list<ClassNode*> > ();
        break;
      ...
      case 48: // formals
      case 49: // formals-list
        value.template destroy< std::list<FormalNode*> > ();
        break;
      ...
      case 46: // class-body
      case 47: // class-body-part
        value.template destroy< std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> > ();
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 55: // block
        value.move< BlockExpr* > (s.value);
        break;

      case 50: // class
        value.move< ClassNode* > (s.value);
        break;
      ...
      case 51: // field
        value.move< FieldNode* > (s.value);
        break;

      case 53: // formal
        value.move< FormalNode* > (s.value);
        break;
      ...
      case 45: // classes
        value.move< std::list<ClassNode*> > (s.value);
        break;
      ...
      case 48: // formals
      case 49: // formals-list
        value.move< std::list<FormalNode*> > (s.value);
        break;
      ...
      case 46: // class-body
      case 47: // class-body-part
        value.move< std::tuple<std::list<FieldNode*>, std::list<MethodNode*>> > (s.value);
        break;
  ...
  parser::symbol_type
  parser::make_INTEGER_LITERAL (const int& v, const location_type& l)
  {
  ...
  parser::symbol_type
  parser::make_TYPE_ID (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_TYPE_ID, v, l);
  }

  parser::symbol_type
  parser::make_OBJECT_ID (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_OBJECT_ID, v, l);
  }
  ...
  parser::symbol_type
  parser::make_LOWER_EQUAL (const location_type& l)
  {
...
#line 1741 "parser.tab.hh" // lalr1.cc:377
